...
HD_PWD='/home/jaroslav/Desktop/CTU_FIT/BI-SAP/lib3_adder/lib3_adder/lib3_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder_7seg.tcl

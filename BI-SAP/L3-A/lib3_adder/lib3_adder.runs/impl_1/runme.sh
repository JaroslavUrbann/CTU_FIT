...
HD_PWD='/home/jaroslav/Desktop/CTU_FIT/BI-SAP/lib3_adder/lib3_adder/lib3_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_7seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decoder_7seg.tcl -notrace

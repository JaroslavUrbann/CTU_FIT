...
begin
  ...
  d0 <= ((q0 and not INC) or ((not q0) and INC));
  d1 <= (((not q0) and q1) or (q1 and (not INC)) or (q0 and (not q1) and (not q2) and INC));
  d2 <= ((q2 and (not INC)) or ((not q0) and q2) or (q0 and q1 and INC));

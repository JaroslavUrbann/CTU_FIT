...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.LOGO_FILE {simulation.png} \
   CONFIG.width {4} \
 ] $debounce_0
  ...
  connect_bd_net -net Net [get_bd_ports CE] [get_bd_pins dff_0/ce] [get_bd_pins dff_1/ce] [get_bd_pins dff_2/ce]
  connect_bd_net -net Net1 [get_bd_pins debounce_0/tl_out] [get_bd_pins dff_0/clk] [get_bd_pins dff_1/clk] [get_bd_pins dff_2/clk]
  connect_bd_net -net Net2 [get_bd_ports RESET] [get_bd_pins dff_0/reset] [get_bd_pins dff_1/reset] [get_bd_pins dff_2/reset]
  ...
  connect_bd_net -net q1_0_1 [get_bd_ports S1] [get_bd_pins dff_1/q] [get_bd_pins next_state_logic_0/q1] [get_bd_pins output_logic_0/q1]
  connect_bd_net -net sw_0_1 [get_bd_ports SWITCH] [get_bd_pins next_state_logic_0/sw] [get_bd_pins output_logic_0/sw]
